...
const ProductDelivery = () => {
  return (
    <div className='grid grid-cols-1  gap-5 md:grid-cols-2 lg:grid-cols-2 sm:gap-y-16 bg-base-200 mb-10 
justify-between px-10 pt-10 mx-auto my-auto xs:w-xl  sm:max-w-xl md:max-w-full lg:max-w-screen-xl'>
