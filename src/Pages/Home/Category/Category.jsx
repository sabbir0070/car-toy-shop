...
activeTab =="MiniTruck" ? "bg-orange-500 text-white " :''
}
`}>
Truck
</div>
...
px-6 py-3 w-24 bg-white text-black font-bold rounded-lg ${
activeTab =="MiniBus" ? "bg-orange-500 text-white " :''
}
`}>
Buses
</div>
...
px-6 py-3 w-24 bg-white text-black font-bold rounded-lg ${
activeTab =="MiniPoliceCar" ? "bg-orange-500 text-white " :''
}
`}>
Police
</div>
</div>
<div className='grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-10 my-10 py-5'>
{
